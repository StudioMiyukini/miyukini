...
export function ThemeToggle() {
  ...
  return (
    <button
      ...
      className="w-8 h-8 flex items-center justify-center rounded-md border border-zinc-200 dark:border-zinc-800 text-zinc-500 hover:border-violet-500 hover:text-zinc-900 dark:hover:text-zinc-100 transition-colors cursor-pointer"
    >
      {theme === "dark" ? (
